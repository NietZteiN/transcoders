...
- Hypotheses/experiments/tasks formalized into `../../CHECKLIST.md` (HT1–HT8 ↔ E1–E8; phased to-do).
...
## Entries
- `2026-07-24_hypotheses-checklist.md` — formalized HT1–HT8 + phased task list into `CHECKLIST.md`.
...
## Doc / results links
- [`../../CHECKLIST.md`](../../CHECKLIST.md) — hypotheses ledger (HT1–HT8), experiment tracker, phased task list.
