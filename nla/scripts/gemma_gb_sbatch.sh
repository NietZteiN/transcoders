...
#SBATCH --output=/work/jvl210002/migration/transcoders/log/slurm/%A_%a_gemma_gb.out
#SBATCH --error=/work/jvl210002/migration/transcoders/log/slurm/%A_%a_gemma_gb.out
set -uo pipefail
...
python nla/src/p1b_ladder.py --host gemma12b --tier "$T" --draws 10
